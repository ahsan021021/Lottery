...
const AdminDashboard: React.FC = () => {
    ...
    const handleSendManualTicket = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post('http://82.180.137.7:5001/ticket/purchase', data);
                            ...
                            <div className="mb-6">
                                ...
                                <div className="border border-gray-200 rounded-lg p-2">
                                    <div className="bg-gray-100 rounded flex items-center justify-center p-4">
                                        <img
                                            src={`http://82.180.137.7:5001/uploads/${selectedTicketDetails.paymentScreenshot}`}
                                    ...
                                    <div className="mt-2 text-center">
                                        <a
                                            href={`http://82.180.137.7:5001/uploads/${selectedTicketDetails.paymentScreenshot}`}
                                            target="_blank"
